...
class LoginController: UIViewController {
    ...
    @objc func handleLogin() {
        ...
        Auth.auth().signIn(withEmail: email, password: password, completion: {(user, error) in
            if let error = error {
                print("Faild to login with email: ", error)
                return
            }
    ...
    override func viewDidLoad() {
        ...
        dontHaveAccountButton.anchor(top: nil, left: view.leftAnchor, bottom: view.safeAreaLayoutGuide.bottomAnchor, right: view.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingBottom: -20, paddingRight: 0, width: 0, height: 50)
